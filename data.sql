...
CREATE TABLE public._menu (
    ...
    new_price character varying(4) DEFAULT NULL::character varying,
...
6	1	Curried Caesar Salad	6.95	From the Field	Crunchy romaine lettuce, plum tomatoes, cottage cheese tossed in curried caesar dressing, topped with crisps. -Choice of shrimp($4.00) or Chicken tikka($3.00) extra-	0.4	4.17	133
...
30	1	Ennai Kathirikai	12.95	Mains - Vegetarian	baby eggplant, roasted spices, tomatoes, onions, coconut paste.			
...
84	1	Sambhar Idly	6.95	Chennai Specials	Spongy steamed rice cakes served immersed in mildly spiced sambhar. (Vegan)			
